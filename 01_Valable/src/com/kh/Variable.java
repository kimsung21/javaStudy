...
public class Variable {
	...
	public static void decalreVariable() {
		/*
		 ...
		 * 		- 상수 : 스네이크케이스(SANK_CASE). 모두 대문자로 작성하고 다른 단어는 _로 구분
		 *  [2] 예약어(키워드)는 사용할 수 없음.(ex. static void public..)
		 *  [3] 공백 사용 불가
		 *  [4] 특수문자는 _와 $만 사용 가능.
		 *  [5] 숫자로 시작할 수 없음.
		...
		// 1. 논리형 (boolean) : 논리값을 저장. ture, false. 1byte.
		// true 값을 저장하는 isTure라는 변수 선언 및 초기화
		...
		//  byte 자료형 변수 bNum를 선언하고 저장할 수 있는 최소값 저장
		...
		float fNum = 0.0f; // 소숫점 7자리까지 표현 가능 자료형
						   // 값 자체(리터럴)를 저장할 떄는 접미사 f/F를 붙여줌
		
		double dNum = 0.0; // 솟수점 15자리까지 표현 가능
						   // 실수형의 기본자료형*
		//------------------------
		// 3. 문자형 (char, String)
		// 3-1) 문자 : char (2B)
